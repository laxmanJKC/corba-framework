...
public abstract class NioSSLPeer {
	 ...
	 * {@link NioSslPeer#myAppData}. It should be initialized using
	 ...
	 * @param engine        - the engine that will be used for encryption/decryption
	 *                      of the data exchanged with the other peer.
	...
	/**
	 * Creates the key managers required to initiate the {@link SSLContext}, using a
	 * JKS keystore as an input.
	 *
